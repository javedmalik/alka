const overviewContent = {
  ...
  paragraphs: [
    ...
    Learning is for everyone, and it shapes who we become. 
    ...
    By nurturing purpose-driven growth, we aim to create communities that move forward with clarity, empathy, and heart.`,
  ],
